...
class _QuestionTitleWithIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String>? triple = questionIconsTriple[identifier];

    final String single = questionIcons[identifier] ?? Mdi.help_circle;
...
class _TripleIconHeader extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final List<String> display = icons.take(4).toList();
